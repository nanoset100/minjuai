-- MinjuAI Policy Ontology Schema v1.0

CREATE EXTENSION IF NOT EXISTS "pgcrypto";

-- 1. Policy Topics (52 areas)
...
-- 3. Ontology Nodes (Knowledge Graph)
